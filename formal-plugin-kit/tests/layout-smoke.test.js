...
assert.ok(manifest.includes('"version": "0.20.1-alpha"'));
assert.ok(excelManifest.includes('"name": "wps-ai-assistant-et"'));
assert.ok(excelManifest.includes('"version": "0.20.1-alpha"'));
...
assert.ok(excelRibbonJs.includes('build=0.20.1-alpha'));
...
assert.ok(pptManifest.includes('"version": "0.20.1-alpha"'));
...
assert.ok(pptRibbonJs.includes("build=0.20.1-alpha"));
...
assert.ok(html.includes('./taskpane.css?v=0.20.1-alpha'));
assert.ok(html.includes('./taskpane-helpers.js?v=0.20.1-alpha'));
assert.ok(html.includes('./taskpane.js?v=0.20.1-alpha'));
...
assert.ok(js.includes('FRONTEND_BUILD_VERSION = "0.20.1-alpha"'));
...
assert.ok(ribbonJs.includes('build=0.20.1-alpha'));
