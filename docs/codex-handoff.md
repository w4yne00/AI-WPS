...
当前没有活动的自动化候选。归档记录 `AI-WPS-P1-WORD-EXCEL-PPT-0.25.1-20260824-5318d4b496d272a5f34bd270c714216f5b6c2e43`（源码提交同值，归档 `dist-phase1-delivery-kit/ai-wps-phase1-delivery-20260824-5318d4b-v0251.tar.gz`，SHA-256 `2b5b48b7728c729016a97744af88d80a44fac63a2df7aa5eaf6ee32b50bf4320`）已登记为 `rejected`：真实 JS coverage 与 Adapter 重算不一致，commit 在后台任务启动前返回 `DETERMINISTIC_FORMAT_REVIEW_SNAPSHOT_MISMATCH`。修复源尚未形成候选，必须重新构建新归档后才可产生新的 `candidate`。上一候选 `AI-WPS-P1-WORD-EXCEL-PPT-0.25.1-20260824-2e7a3e6b18aa5d297edd8c66b1475c53b3f4b06f` 已登记为 `rejected`；其归档为 `dist-phase1-delivery-kit/ai-wps-phase1-delivery-20260824-2e7a3e6-v0251.tar.gz`，SHA-256 为 `576ad6580fc261e486adb3bac784d2e2a7f47c4f62209686bb1e2e58b5599c1e`，原因是包内交付说明过期且缺失大纲事实被写为 `null`。Issue #59 的目标 WPS GUI、真实模型和人工文档验收仍为 `manual-pending`，不得写为 `passed` 或 `accepted`。
...
- `20260824-ccad09f`、`20260824-2e7a3e6` 与 `20260824-5318d4b` 均已在 `packaging/v0251-candidate-status.json` 登记为 `rejected`；当前没有自动化候选，修复源在新归档构建前不得分发，不替代 Issue #59 目标机验收。
...
- 历史 `20260824-ccad09f`、`20260824-2e7a3e6` 和 `20260824-5318d4b` 归档均已登记 `rejected`，不得分发；当前没有自动化候选，修复源在新归档构建前不得作为候选。
...
- 被拒绝的 `20260824-5318d4b` 归档保持不可变，记录 SHA-256 为 `2b5b48b7728c729016a97744af88d80a44fac63a2df7aa5eaf6ee32b50bf4320`；本轮未构建新归档。
