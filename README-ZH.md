...
| 交付状态 | 0.25.2 唯一自动化候选为 `20260825-850871c`（`candidate`）；`20260825-dacd1e9` 与 `20260825-0f50456` 为 `rejected`；冻结的 0.25.1 候选仍为 `20260824-d7a1dd8`；Issue #59 仍为 `manual-pending` |
| 一期交付包 | `ai-wps-phase1-delivery-20260825-850871c-v0252.tar.gz`，SHA-256：`c5d663d1249147104bee66790fea60f5e15675418a51c0c1a7a0fc028a285a92`；源码提交：`850871c10a17f03c8a58abd02ca58c2f3fc70fc9` |
